            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="pass-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirmá tu contraseña') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">{{ __('Subí un avatar') }}</label>
